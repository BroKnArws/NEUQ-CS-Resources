...
public class FIFOStrategy implements Replacement {
    ...
    public FIFOStrategy(int[][] instructions) {
    ...
    public void run() {
            ...
            for (int j = 0; j < instructions[i].length; j++) {
                ...
                if (existedPages.contains(pageNum)) {
                    ...
                    if (memoryPagesList.size() >= MAX_PAGE_SIZE) {
                        Block discard = memoryPagesList.get(last);
        ...
        System.out.println("====================================");
        System.out.println("FIFO 缺页次数是 " + discardCount);
        System.out.println("FIFO 缺页率是 " + (double) discardCount * 100 / (instructions.length * instructions[0].length) + " %");
        System.out.println("====================================");
    }
